...
$('#edit-address-form').submit(function(eer){
  ...
  $('.menuitem-in-mobile').click(function(){
    $(this).toggleClass('active-mob');
    $(this).siblings('.menu-item-child-mobile').slideToggle();
    $(this).parent().parent().siblings().find('.menuitem-in-mobile').removeClass('active-mob');
    $(this).parent().parent().siblings().find('.menu-item-child-mobile').slideUp();
  });
...
$(document).on("click", ".cart-inc", function(e){
    ...
    var cartItemMax = $(this).siblings('.quantity__input').attr('data-max');
